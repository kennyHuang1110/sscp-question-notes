...
**Answer:** A. Computers, climate control, cables and peripherals
...
**Answer:** C. Disaster Recovery Manager.
...
**Answer:** A. single loss expectancy x annualized rate of occurrence.
...
**Answer:** D. Conduct of a successful Parallel Test
...
**Answer:** A. It is unlikely to be affected by the same disaster.
...
**Answer:** B. Discretionary expense.
...
**Answer:** D. Information gathering would be minimized and expedited due to the amount of information already built into the tool.
...
**Answer:** C. To refresh the investigators memory while testifying.
...
**Answer:** C. They hold a position of trust
...
**Answer:** A. System development activity
...
**Answer:** B. uninterruptible power supplies
...
**Answer:** A. Notifying senior management of the start of the assessment.
...
**Answer:** A. Value of item on the date of loss
...
**Answer:** B. Based on new, comparable, or identical item for old regardless of condition of lost item
...
**Answer:** D. It is maximum delay businesses can tolerate and still remain viable
...
**Answer:** A. Alternate site selection
...
**Answer:** C. Formal approval of BCP scope and initiation document
...
**Answer:** C. The least critical functions should be moved back first
...
**Answer:** A. The security risk that remains after controls have been implemented
...
**Answer:** A. Availability of the CIA triad
...
**Answer:** C. Physical, technical, and administrative
...
**Answer:** D. Analysis and tracking
...
**Answer:** C. Stateful matching scans for attack signatures by analyzing individual packets instead of traffic streams
...
**Answer:** A. Incremental backup method.
...
**Answer:** A. differential backup method
...
**Answer:** D. Digital Audio Tape (DAT).
...
**Answer:** A. Hierarchical Storage Management (HSM).
...
**Answer:** A. Operations Security Domain.
...
**Answer:** C. Quantitatively measuring the results of the test
...
**Answer:** A. It should have the same amount of physical access restrictions as the primary processing site.
...
**Answer:** D. Contain and repair any damage caused by an event.
...
**Answer:** B. The Federal Sentencing Guidelines of 1991.
...
**Answer:** C. To ensure that it will be admissible in court
...
**Answer:** B. The top-down approach
...
**Answer:** D. Choose the best countermeasure
...
**Answer:** C. The process of reducing risk to an acceptable level
...
**Answer:** D. It requires little experience to apply
...
**Answer:** A. Develop an information security policy.
...
**Answer:** C. Differential backup method
...
**Answer:** B. Incremental backup method
...
**Answer:** D. Develop a mission statement.
...
**Answer:** B. Mirroring is a hardware-based solution only.
...
**Answer:** B. The Contingency Planning Coordinator should make sure that every employee gets an up-to-date copy of the plan.
...
**Answer:** A. Contact information for all personnel.
...
**Answer:** D. Load balancing/disk replication
...
**Answer:** B. The Business Impact Analysis (BIA)
...
**Answer:** B. Recovery Time Objectives (RTO)
...
**Answer:** D. Identify and Prioritize Critical Organization Functions
...
**Answer:** B. Data/Telecomm/IS facilities
...
**Answer:** C. Assess damage to LAN and servers
...
**Answer:** A. In order to facilitate recovery, a single plan should cover all locations.
...
**Answer:** A. It is implemented to gather input from all personnel that is going to be part of the recovery teams.
...
**Answer:** D. Structured walk-through test
...
**Answer:** A. (C < L) or C is less than L
...
**Answer:** B. Exigent Circumstance Doctrine
...
**Answer:** C. mitigate risk and reduce the potential for loss
...
**Answer:** C. An uncertainty analysis
...
**Answer:** D. The chain of custody of the evidence must show who collected, secured, controlled, handled, transported the evidence, and that it was not tampered with.
...
**Answer:** C. A copy of a piece of evidence
...
**Answer:** A. It prioritizes the risks and identifies areas for immediate improvement in addressing the vulnerabilities.
...
**Answer:** A. Is damaged media stored and/or destroyed?
...
**Answer:** B. A proper chain of custody of evidence has to be preserved.
...
**Answer:** C. Verifiable documentation indicating the who, what, when, where, and how the evidence was handled should be available.
...
**Answer:** D. Within the first week of completing the investigation of the intrusion.
...
**Answer:** B. Senior business unit management
...
**Answer:** A. Every organization must have a disaster recovery plan
...
**Answer:** C. It provides a false sense of security.
...
**Answer:** A. Full Interruption test
...
**Answer:** D. When returning to the primary site, the most critical applications should be brought back first.
...
**Answer:** C. Computer-generated records are only considered secondary evidence, thus are not as reliable as best evidence.
...
**Answer:** B. Records are collected by senior or executive management.
...
**Answer:** A. Disgruntled employees
...
**Answer:** C. An organization that coordinates and supports the response to security incidents.
...
**Answer:** B. They have not exercised due care protecting computing resources.
...
**Answer:** A. All areas of the enterprise.
...
**Answer:** C. The names of individuals to be contacted during a disaster.
...
**Answer:** A. A site with pre-installed computers, raised flooring, air conditioning, telecommunications and networking equipment, and UPS.
...
**Answer:** D. Real time transmission of copies of the entries in the journal of transactions to an alternate site.
...
**Answer:** A. Loss of skilled workers knowledge
...
**Answer:** C. Continous auditing makes a Disaster Recovery plan irrelevant
...
**Answer:** D. A transfer of bulk information to a remote central backup facility.
...
**Answer:** B. Least critical components
...
**Answer:** C. the monitoring of threat activity for adjustment of technical controls
